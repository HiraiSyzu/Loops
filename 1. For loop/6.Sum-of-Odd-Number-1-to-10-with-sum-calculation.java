...
// My Explanation:
// This is just the same to the previous question, but instead of counting how many are the odd numbers, we will add them together. The loop will add the odd numbers (1, 3, 5, 7, 9) to the sum variable. The result will be 25.
