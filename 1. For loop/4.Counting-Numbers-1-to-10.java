...
// My Explanation:
// In this case, we count the even numbers between 1 and 10 by checking if each number is divisible by 2 (i % 2 == 0). The loop increments the sum each time it finds an even number. 
